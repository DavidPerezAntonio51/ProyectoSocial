            ...
            <Grid container>
                ...
                <Grid item>
                    <Box sx={{
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img2} alt="Imagen 2" height="400" width="800" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img4} alt="Imagen 3" height="400" width="550" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img5} alt="Imagen 4" height="400" width="550" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img6} alt="Imagen 5" height="400" width="550" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img3} alt="Imagen 6" height="350" width="550" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img11} alt="Imagen 7" height="160" width="650" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img8} alt="Imagen 8" height="350" width="300" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img9} alt="Imagen 9" height="340" width="300" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img12} alt="Imagen 10" height="320" width="300" />
                        </Grid>
                        <Typography variant="body1" component="p">
                        ...
                        <Grid sx={{ textAlign: "center", padding: 5 }}>
                            <img src={img13} alt="Imagen 11" height="350" width="550" />
                        </Grid>
                        <Typography variant="body1" component="p">
