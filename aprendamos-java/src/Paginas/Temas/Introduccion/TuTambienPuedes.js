            ...
            <Grid item>
                <Box sx={{
                    ...
                    <Typography align="justify" component="p" variant="body1">
                        ...
                        Hoy discutiremos un tema importates, y es el que programar es una actividad que podría resultar sencillo en cuanto al hecho de aprender sintáxis, aspectos del lenguaje, entre otros puntos. No te preocupes, todos estos temas los veras más adelante. Pero si realmente quieres destacar en este bello mundo hace falta mucho esfuerzo de por medio y dedicación en el aprendizaje (especialmente en la práctica), aquí nos encargaremos de que recibas unas bases sólidas para que seas capaz de interpretar código de otros lados, o incluso, puedas adentrarte en diferentes complementos de Java para que puedas trabajar aplicaciones cada vez más complejas. <br/> <br/>
                        Puede que todo esto resulte abrumador, pero no te preocupes, programar no es una actividad que se aprende de la noche a la mañana, eso es super claro, oeri si dedicas tiempo y dedicación, podrás convertirte en un programador con un gran set de conocimientos. ¡Tú puedes, {Usuario.User} no te rindas! 
                    </Typography>
                    <center>
